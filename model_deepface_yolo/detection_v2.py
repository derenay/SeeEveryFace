...
class AppConfig:
    ...
    YOLO_FACE_MODEL_PATH: str = 'project-02/yolov11m-face.pt' # Model yolunu güncelleyin
    DEEPFACE_DETECTOR_BACKEND_FOR_CROPS: str = 'skip'
    DEFAULT_RECOGNITION_THRESHOLD: float = 0.50
    FAISS_INDEX_FILE: str = 'project-02/yenidenemem_few_shot/face_teslim/face_db/Human/face_index_v5_facenet512.index' # Index dosya yolunu güncelleyin
...
def main_application():
    ...
    input_media_path = "/home/earsal@ETE.local/Desktop/lightweight-human-pose-estimation-3d-demo.pytorch-master/09b-1734119114698.mp4x"  
